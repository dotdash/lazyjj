...
impl Default for LogTabKeybinds {
    fn default() -> Self {
        ...
        set_keybinds!(
            ...
            LogTabEvent::DescribeInteractive => "shift+d",
...
impl LogTabKeybinds {
    ...
    pub fn extend_from_config(&mut self, config: &LogTabKeybindsConfig) {
        update_keybinds!(
            ...
            LogTabEvent::DescribeInteractive => config.describe_interactive,
    ...
    pub fn make_main_panel_help(&self) -> Vec<(String, String)> {
        make_keybinds_help!(
            ...
            LogTabEvent::DescribeInteractive => "describe change interactive",
